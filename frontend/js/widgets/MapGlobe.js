...
export default class MapGlobe extends Widget {
    constructor(container, menuContainer) {
        ...
        let svg = d3.select(container)
            ...
            .append("g").attr("id", "map-globe-content");
    ...
    loadMap(mapObj) {
        ...
        d3.json(url, function (error, topoMap) {
            ...
            let zoomer = self.zoomer = new MapZoomer(self.container, "#map-globe-content", self.svg);
            zoomer.zoom.on("zoom.labels", function () {
                ...
                cityLabelSelection.enter().append("text")
                    ...
                    .attr("dy", "0.5em")
                    .style("font-size", 8 / zoomer.currentScale);
